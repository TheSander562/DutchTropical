...
<b>Description:</b> Allow your players to post a Ban Appeal<br />
						...
						<br /><br />
						<strong><?php echo $admin_language['questions']; ?></strong> <span class="pull-right"><a href="/admin/addons/?action=edit&amp;addon=BanAppeal&amp;module_action=new" class="btn btn-primary"><?php echo $banappeal_language['new_question']; ?></a></span><br /><br />
						<?php 
						...
						<?php
								'<a href="/admin/addons/?action=edit&addon=BanAppeal&question=' . $question->id . '"></a><br />';
							}
						} else {
